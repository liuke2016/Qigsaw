...
public interface SplitInstallManager {
    ...
    /**
     * Starts the user confirmation dialog from the provided {@link SplitInstallSessionStatus}.
     */
    ...
    Task<Void> deferredLanguageInstall(java.util.List<java.util.Locale> languages);

    Task<Void> deferredLanguageUninstall(java.util.List<java.util.Locale> languages);
